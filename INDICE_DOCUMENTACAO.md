...
| [docs/RAFAELIA_CLAIM_EXECUTION_MATRIX.md](docs/RAFAELIA_CLAIM_EXECUTION_MATRIX.md) | Matriz claim → arquivo → teste → status → falsificação → rollback para sementes RAFAELIA | IA/Desenvolvedores |
