...
int main(int argc,char**argv){
  ...
  E e[]={{"BOOTSTRAP_INFO",(uint8_t*)info,(uint32_t)info_n,0,0},{"SYMLINKS.txt",symlinks_buf,(uint32_t)(sizeof(symlinks_buf)-1),0,0},{"BUILD_ONLY",build_only_buf,build_only_n,0,0},{"bin/sh",sh_buf,sh_n,0,0},{"bin/pkg",pkg_buf,pkg_n,0,0},{"bin/busybox",busybox_buf,busybox_n,0,0},{"bin/proot",proot_buf,proot_n,0,0},{"bin/apkmanager",apkmanager_buf,apkmanager_n,0,0},{"bin/shellbash",shellbash_buf,shellbash_n,0,0},{"bin/busybox-safe",busybox_safe_buf,busybox_safe_n,0,0},{"bin/proot-safe",proot_safe_buf,proot_safe_n,0,0},{"etc/motd",motd_buf,motd_n,0,0}};
